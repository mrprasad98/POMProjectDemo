...
public WebDriver driver = null;	
	...
	// Reusable methods for Browser Levels (Generic Methods)
	...
	eTest.log(LogStatus.INFO, browserType + "Browser Opened");
		driver.manage().window().maximize();
eTest.log(LogStatus.INFO, "Browser Maximized");
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	}

public void reportPass(String message)
{
	eTest.log(LogStatus.INFO, message);
}
